                                              ...
                                              IDisposable
{
    ...
    /// <param name="directoryStructure">Preserve directory structure.</param>
    public ArchiveUpdateCallback(
        Stream stream, SharpSevenZipCompressor compressor, UpdateData updateData, bool directoryStructure)
    {
    ...
    /// <param name="directoryStructure">Preserve directory structure.</param>
    public ArchiveUpdateCallback(
        Stream stream, string password, SharpSevenZipCompressor compressor, UpdateData updateData,
    ...
    private void CommonInit(SharpSevenZipCompressor compressor, UpdateData updateData, bool directoryStructure)
    {
    ...
    private void Init(
        FileInfo[]? files, int rootLength, SharpSevenZipCompressor compressor,
        ...
        try
        {
            switch (propID)
            {
                ...
                case ItemPropId.Path:
                    ...
                    string val = DefaultItemName ?? string.Empty;
                    ...
                    if (_updateData.Mode != InternalCompressionMode.Modify)
                    {
                        ...
                        else
                        {
                            if (_directoryStructure)
                            {
                                if (_rootLength > 0)
                                {
                                    val = _files[index].FullName[_rootLength..];
                                }
                                else
                                {
                                    val = _files[index].FullName[0] + _files[index].FullName[2..];
                                }
                            }
                            else
                            {

        ...
        try
        {
            ...
            if (coreWebView2.Source is "about:blank" || force)
            {
                ...
                string? url = (CurrentGameBiz.IsGlobalServer(), CurrentGameBiz.ToGame()) switch
                {
                    ...
                    (true, GameBiz.ZZZ) => "https://act.hoyolab.com/app/zzz-game-record/m.html?gid=8",
                    ...
                    (false, GameBiz.ZZZ) => "https://act.mihoyo.com/app/mihoyo-zzz-game-record/m.html?game_id=8",
                    _ => null,
                };
                if (url is not null)
                {

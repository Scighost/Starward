...
internal static class HttpClientGetPartialExtensions
{
    ...
    {
        return GetPartial(httpClient, requestUri, new RangeHeaderValue(from, to), acceptType);
    }
    ...
    {
        return GetPartialAsync(httpClient, requestUri,new RangeHeaderValue(from, to), acceptType, cancellationToken);
    }
    ...
    /// </exception>
    public static HttpResponseMessage GetPartial(this HttpClient httpClient,
        Uri requestUri, RangeHeaderValue rangeHeaderValue, string? acceptType)
    {
    ...
    public static HttpResponseMessage GetPartial(this HttpClient httpClient,
        ...
        GetPartial(httpClient, new Uri(requestUri), rangeHeaderValue, acceptType);
    ...
    public static Task<HttpResponseMessage> GetPartialAsync(this HttpClient httpClient,
        ...
        GetPartialAsync(httpClient, new Uri(requestUri), rangeHeaderValue, acceptType, cancellationToken);
}
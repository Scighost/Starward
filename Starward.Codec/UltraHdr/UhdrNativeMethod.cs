...
public static partial class UhdrNativeMethod
{
    ...
    public static partial IntPtr uhdr_create_encoder();

    /// <summary>
    /// Release encoder instance. Frees all allocated storage associated with encoder instance.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial void uhdr_release_encoder(IntPtr enc);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_raw_image(IntPtr enc, ref UhdrRawImage img, UhdrImageLabel intent);

    /// <summary>
    /// Add compressed image descriptor to encoder context. Checks all fields for sanity and adds to internal list.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_compressed_image(IntPtr enc, ref UhdrCompressedImage img, UhdrImageLabel intent);

    /// <summary>
    /// Add gain map image descriptor and gainmap metadata info to encoder context.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_gainmap_image(IntPtr enc, ref UhdrCompressedImage img, ref UhdrGainmapMetadata metadata);

    /// <summary>
    /// Set quality factor for compressing base image and/or gainmap image. Quality in range [0 - 100].
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_quality(IntPtr enc, int quality, UhdrImageLabel intent);

    /// <summary>
    /// Set Exif data that needs to be inserted in the output compressed stream.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_exif_data(IntPtr enc, ref UhdrMemoryBlock exif);

    /// <summary>
    /// Enable/Disable multi-channel gainmap. 0 - single-channel enabled, otherwise multi-channel.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_using_multi_channel_gainmap(IntPtr enc, int use_multi_channel_gainmap);

    /// <summary>
    /// Set gain map scaling factor. Factor in range (0, 128].
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_gainmap_scale_factor(IntPtr enc, int gainmap_scale_factor);

    /// <summary>
    /// Set encoding gamma of gainmap image. Any positive real number.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_gainmap_gamma(IntPtr enc, float gamma);

    /// <summary>
    /// Set min max content boost. Value MUST be in linear scale.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_min_max_content_boost(IntPtr enc, float min_boost, float max_boost);

    /// <summary>
    /// Set target display peak brightness in nits. Range [203, 10000].
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_target_display_peak_brightness(IntPtr enc, float nits);

    /// <summary>
    /// Set encoding preset. Choose between best performance or best quality.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_preset(IntPtr enc, UhdrEncodePreset preset);

    /// <summary>
    /// Set output image compression format.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_enc_set_output_format(IntPtr enc, UhdrImageFormat media_type);

    /// <summary>
    /// Encode process call. Submits data for encoding.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_encode(IntPtr enc);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_get_encoded_stream(IntPtr enc);

    /// <summary>
    /// Reset encoder instance to default state.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial void uhdr_reset_encoder(IntPtr enc);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_create_decoder();

    /// <summary>
    /// Release decoder instance.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial void uhdr_release_decoder(IntPtr dec);

    /// <summary>
    /// Add compressed image descriptor to decoder context.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_dec_set_image(IntPtr dec, ref UhdrCompressedImage img);

    /// <summary>
    /// Set output image color format.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_dec_set_out_img_format(IntPtr dec, UhdrPixelFormat fmt);

    /// <summary>
    /// Set output image color transfer characteristics.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_dec_set_out_color_transfer(IntPtr dec, UhdrColorTransfer ct);

    /// <summary>
    /// Set output display's HDR capacity. Value >= 1.0f.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_dec_set_out_max_display_boost(IntPtr dec, float display_boost);

    /// <summary>
    /// Parse the bitstream registered with decoder context and make image info available.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_dec_probe(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial int uhdr_dec_get_image_width(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial int uhdr_dec_get_image_height(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial int uhdr_dec_get_gainmap_width(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial int uhdr_dec_get_gainmap_height(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_dec_get_exif(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_dec_get_icc(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_dec_get_base_image(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_dec_get_gainmap_image(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_dec_get_gainmap_metadata(IntPtr dec);

    /// <summary>
    /// Decode process call. Submits data for decoding.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial UhdrErrorInfo uhdr_decode(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_get_decoded_image(IntPtr dec);
    ...
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial IntPtr uhdr_get_decoded_gainmap_image(IntPtr dec);

    /// <summary>
    /// Reset decoder instance to default state.
    /// </summary>
    [LibraryImport(LibraryName)]
    public static partial void uhdr_reset_decoder(IntPtr dec);

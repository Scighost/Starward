[English](./Configuration.md) | [简体中文](./Configuration.zh-CN.md) | Tiếng Việt
...
| EnableDynamicAccentColor        | bool    | -             | Màu chủ đề động được tính từ ảnh nền, và màu chủ đề hệ thống được sử dụng khi tắt.                                                                                |
